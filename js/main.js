...
listItems.forEach(item => {
	...
	item.addEventListener('mouseover', function() {
		this.style.opacity = '0.7'; // Example: Change opacity on hover
		// Add additional styles/animations as desired
	});

	// Add mouseout event listener
	item.addEventListener('mouseout', function() {
		this.style.opacity = '1'; // Example: Restore opacity on mouseout
		// Add additional styles/animations as desired
	});
});
